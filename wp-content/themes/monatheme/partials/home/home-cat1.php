...
if ( content_exists( $mona_home_section_cat1 ) ) {
	?>
	<?php
	foreach ( $mona_home_section_cat1 as $key_cat1 => $item_cat1 ) {
		?>
            ...
            <div class="container">
                <div class="home-prodbox-wr tabJS">
                    <div class="head" data-aos="fade-up">
						<?php
						$cat1_category = $item_cat1['cat1_category'];
						?>
                        <h3 class="head-tt"><?php
						...
						<?php
						$cat1_brand = $item_cat1['cat1_brand'];
						?>
						<?php
                    ...
                    <div class="home-prodbox-panel" data-aos="fade-up" data-aos-delay="400">
						<?php
						if ( content_exists( $item_cat1['cat1_brand'] ) ) {
							?>
							<?php
							foreach ( $item_cat1['cat1_brand'] as $key_brand => $item_brand ) {
								if ( ! empty( $item_brand ) ) {
									?>
									<?php
