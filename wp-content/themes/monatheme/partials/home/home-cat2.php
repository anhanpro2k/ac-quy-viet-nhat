...
if ( content_exists( $mona_home_section_cat2 ) ) {
	?>
	<?php
	foreach ( $mona_home_section_cat2 as $key_cat2 => $item_cat2 ) {
		?>
            ...
            <div class="container">
                <div class="home-prodbox-wr tabJS">
                    <div class="head" data-aos="fade-up">
						<?php
						$cat2_category = $item_cat2['cat2_category'];
						?>
						<?php
						...
						?>
						<?php
						$cat2_brand = $item_cat2['cat2_brand'];
						?>
						<?php
                    ...
                    <div class="home-prodbox-panel" data-aos="fade-up" data-aos-delay="400">
						<?php
						if ( content_exists( $item_cat2['cat2_brand'] ) ) {
							?>
							<?php
							foreach ( $item_cat2['cat2_brand'] as $key_brand => $item_brand ) {
								if ( ! empty( $item_brand ) ) {
									?>
