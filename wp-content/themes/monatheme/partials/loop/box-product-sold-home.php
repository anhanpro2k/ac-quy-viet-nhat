...
$sold           = $product->get_total_sales(); // lấy tổng số sản phẩm đã bán
$stock_quantity = $product->get_stock_quantity(); // lấy số lượng sản phẩm còn trong kho
$sold_percent   = ( $sold + $stock_quantity > 0 ) ? round( ( $sold / ( $sold + $stock_quantity ) ) * 100 ) : 0; // tính phần trăm đã bán được

?>
<div class="product-item col">
    <div class="inner revert">
        <div class="sold">
            <div class="sold-bar">
                <span class="progress" style="width: <?php echo $sold_percent; ?>%;"></span>
            </div>
            <p class="sold-txt"><?php echo __( 'Đã bán', 'monamedia' ); ?>: <?php echo $sold; ?></p>
        </div>
        <div class="img">
            <a href="<?php the_permalink(); ?>" class="img-see">
                <img src="<?php echo get_site_url(); ?>/template/assets/images/eyes.svg"
                     alt="">
            </a>
            <form class="frmAddProductCart">
                ...
                <a href="<?php echo esc_url( $product->add_to_cart_url() ); ?>"
                   class="img-cart mona-add-to-cart-list is-loading-btn">
                    <img src="<?php echo get_site_url(); ?>/template/assets/images/cart.svg"
                         alt="">
                </a>
            </form>
