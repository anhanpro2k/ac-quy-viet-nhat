...
?>
    ...
    <main class="main">
									...
									<?php if ( $loop->have_posts() ): ?>
                                        <div class="is-loading-group" id="monaProductsList">
                                            <div class="home-prodbox-list">
												<?php
												$mona_product_key = get_field( 'mona_product_key', MONA_WC_PRODUCTS );
		...
		<?php
		$mona_product_section_banner_ads2 = get_field( 'mona_product_section_banner_ads2', MONA_WC_PRODUCTS );
		?>
		...
		<?php
		$mona_product_section_content = get_field( 'mona_product_section_content', MONA_WC_PRODUCTS );
		?>
		<?php
