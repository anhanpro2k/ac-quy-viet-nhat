 ...
 * Create widget
 */
class M_Widget_related_post extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'M_Widget_related_post',
			__( 'Mona - Bài viết gần đây/nổi bật', 'monamedia' ),
			[
 ...
 * @return void
 */
function Register_M_Widget_related_post() {
	register_widget( 'M_Widget_related_post' );
}

add_action( 'widgets_init', 'Register_M_Widget_related_post' );