...
while ( have_posts() ):
	...
	<main class="main">
		<div class="new">
            ...
            return false;" class="new-social-link">
												<img src="<?php echo get_site_url();?>/template/assets/images/iconlinked.svg" alt="">
											</a>
										</li>
										<li class="new-social-item">
											<a href="http://www.twitter.com/share?url=<?php echo urlencode(get_the_permalink()); ?>"  onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=500');
                return false;" class="new-social-link">
												<img src="<?php echo get_site_url();?>/template/assets/images/twitter.png" alt="">
											</a>
										</li>
									</ul>
								</div>
