                                ...
                                <ul class="footer-social">
									...
									if ( ! empty( $footer_fb_link ) ) {
                                        ...
                                        <li class="footer-social-item">
                                            <a target="_blank" href="<?php echo $footer_fb_link; ?>"
									...
									if ( ! empty( $footer_ins_link ) ) {
										?>
                                        <li class="footer-social-item">
                                            <a target="_blank" href="<?php echo $footer_ins_link; ?>"
                                               class="footer-social-link">
									...
									if ( ! empty( $footer_tw_link ) ) {
										?>
                                        <li class="footer-social-item">
                                            <a target="_blank" href="<?php echo $footer_tw_link; ?>"
                                               class="footer-social-link">
